...
***
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/1INPlxujcga9tSwvSF6jIw?utm_source=generator&theme=0" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
***
On the left, you can see the ceptogram for the song September by Earth, Wind & Fire, a typical disco song. 
There is a lot of activity in the C02 column. There are some chunks which are more active than others, which represent the chorus. 
